...
txt1 <- c("Estruturas de programação",
          "Introdução ao R e Python",
          "Programação funcional",
          "Estatística descritiva",
          # "ETL",
          "\\textit{Extract, transform and load}",
          "\\textit{pandas} e \\textit{tidyverse}",
          "\\textit{matplotlib} e \\textit{ggplot}",
          "Gráficos interativos",
          "\\textit{Dashboards}",
          "Pesquisa reproduzível",
          "\\textit{Web scraping}")
txt2 <- c("Componentes de \\textit{hardware}",
          "\\textit{Shell script}",
          "Tarefas agendadas",
          "Redes e segurança",
          ...
          "Paralelismo",
          "Distribuição")
txt3 <- c("Cálculo diferencial/integral",
          "Álgebra linear",
...
txt5 <- c("Aprendizado supevisionado",
